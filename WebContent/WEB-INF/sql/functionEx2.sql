...
SELECT TRUNC(345.6789) FROM dual;
SELECT TRUNC(345.6789, 0) FROM dual;
SELECT TRUNC(345.6789, 1) FROM dual;
SELECT TRUNC(345.6789, 2) FROM dual;
SELECT TRUNC(345.6789, -1) FROM dual;

SELECT MOD(135, 3) FROM dual;
SELECT MOD(135, 2) FROM dual;

SELECT CEIL(345.12345) FROM dual;
